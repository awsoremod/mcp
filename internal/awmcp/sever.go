...
import (
	...
	"github.com/awsoremod/mcp/pkg/aw"
...
func NewMCPServer(cfg MCPServerConfig) (*server.MCPServer, error) {
	...
	awServer := aw.NewServer(cfg.Version, server.WithHooks(hooks))
	...
	aw.RegisterResources(awServer, getClient, cfg.Translator)

	// Register the tools with the server
	toolsets.RegisterTools(awServer)

	// if cfg.DynamicToolsets {
	// 	dynamic := aw.InitDynamicToolset(awServer, toolsets, cfg.Translator)
	// 	dynamic.RegisterTools(awServer)
	// }
...
func RunStdioServer(cfg StdioServerConfig) error {
	...
	awServer, err := NewMCPServer(MCPServerConfig{
		Version:         cfg.Version,
		Host:            cfg.Host,
		Token:           cfg.Token,
		Model:           cfg.Model,
	...
	stdioServer := server.NewStdioServer(awServer)
	...
	_, _ = fmt.Fprintf(os.Stderr, "MCP Server running on stdio\n")
